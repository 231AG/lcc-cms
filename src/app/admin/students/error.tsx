    ...
    <main id="main-content" tabIndex={-1} className="mx-auto w-full max-w-lg flex-1 px-4 py-12 outline-none">
      <Card>
        <CardBody className="text-center">
          <span className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-danger-50">
            <AlertTriangle className="h-5 w-5 text-danger-600" aria-hidden="true" />
          </span>
          <h1 className="text-base font-semibold text-neutral-900">Could not load students</h1>
