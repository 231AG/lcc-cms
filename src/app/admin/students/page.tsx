  ...
  return (
    <main id="main-content" tabIndex={-1} className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 outline-none sm:py-10">
      ...
      <Card className="overflow-hidden">
        <div className="flex flex-wrap items-end justify-between gap-3 border-b border-neutral-100 px-4 py-4 sm:px-5">
          <div>
            <h2 className="text-sm font-semibold text-neutral-900">Students Information</h2>
        ...
        <form method="GET" className="flex flex-wrap items-end gap-2 border-b border-neutral-100 px-4 py-3 sm:px-5">
        ...
        {rows.length > 0 ? (
          ...
          <div className="px-4 py-12 text-center sm:px-5">
            <p className="text-sm font-medium text-neutral-900">No students found</p>
            {hasFilters ? (
              <>
