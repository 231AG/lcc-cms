  ...
  const header = (
    <Card className="mb-6">
      <CardBody className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link href={backHref} className="text-sm font-medium text-brand-fg hover:underline">
        ...
        <Card className="mb-6">
          <CardBody className="flex flex-wrap items-center gap-3">
            ...
            {plan.status === "REJECTED" && plan.rejectionReason && (
              <span className="text-sm text-danger-fg">Reason: {plan.rejectionReason}</span>
            )}
            <Link href={`/admin/planning/${plan.id}`} className="ml-auto text-sm font-medium text-brand-fg hover:underline">
