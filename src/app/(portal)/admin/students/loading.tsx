  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 outline-none sm:py-10">
      ...
      <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-sm">
        <div className="flex items-end justify-between gap-3 border-b border-line-subtle px-4 py-4 sm:px-5">
        ...
        <div className="flex flex-wrap gap-2 border-b border-line-subtle px-4 py-3 sm:px-5">
